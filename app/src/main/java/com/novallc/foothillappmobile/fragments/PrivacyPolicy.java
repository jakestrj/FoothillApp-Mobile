...
public class PrivacyPolicy extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActionBar.setTitle("Privacy Policy");
        super.onCreate(savedInstanceState);
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View aboutUsView = inflater.inflate(R.layout.privacy_policy, container, false);
        TextView subtitle = (TextView) aboutUsView.findViewById(R.id.privacy_subtitle);
        TextView description = (TextView) aboutUsView.findViewById(R.id.privacy_description);
        ((TextView) aboutUsView.findViewById(R.id.privacy_company_name)).setTypeface(BaseActivity.sRobotoThin);
